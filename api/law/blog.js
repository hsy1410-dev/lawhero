...
3.체크리스트로 시작하기
작성자가 물어본 사기수법에 대한 내용을 체크리스트4개 정도 있는 형식으로 만들고
마지막에는 해당 체크리스트에 대한 충고를 하며 이 글을 읽어야 한다는 내용을 써줘
...
이런 궁금증 해결을 원하신다면 이 글 끝까지 읽어보세요!)",
  "body": "string (markdown, H2/H3 구조 포함, 본문 전체,최소 3개의 소제목 포함, SEO 키워드 4~5회 자연 삽입, 2,000자 이상.  , 전체 문체는 구성 선택 번호에 따라 일관성 유지., 글 쓸 때 마다 글의 구성과 문단의 순서가 완전히 달라야함)",
